                    ...
                    <div class="bg-white border-b border-gray-100 flex justify-between">
                        <div class="px-6 py-5 flex items-center">
                            ...
                            @if(request('filter') || request('search'))
                                <div class="ml-2">
                                    <a class="text-blue-700" href="{{route('events-action.index')}}">Clear search</a>
                                </div>
                            @endif
                        </div>
                        <div class="px-6 py-5 flex items-center">
                            <a class="bg-blue-700 hover:bg-blue-600 text-white px-4 py-2 rounded-lg" href="{{route('events-action.create')}}">Add new</a>
                        </div>
                    </div>
                </form>
                                ...
                                <tr>
                                    ...
                                    <td class="p-2 whitespace-nowrap">
                                        <div class="text-lg text-center flex">
                                            <a href="{{route('events-action.edit', $event->id)}}" class="text-blue-700 mr-3">Edit</a>
                                            <form onsubmit="return confirm('Do you really want to delete?')" action="{{route('events-action.destroy', $event->id)}}" method="post">
                                                @csrf
                                                @method('DELETE')
